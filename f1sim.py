...
if brazilsim == True:
	for x in range(0, 1000):
	    ...
	    print(r)
	    if r > 0 and r <= 3.57:#case 1:
		print("c1")
		case = 1
		rosberg.brazil = 25
		hamilton.brazil = 0
	    elif r > 3.57 and r <= 37.5:#case 2:
		print("c2")
		case = 2
		rosberg.brazil = 18
		hamilton.brazil = 25
	    elif r > 37.5 and r <= 57.14:#case 3:
		print("c3")
		case = 3
		rosberg.brazil = 25
		hamilton.brazil = 18
	    elif r > 57.14 and r <= 60.71:#case 4:
		print("c4")
		case = 4
		rosberg.brazil = 18
		hamilton.brazil = 0
	    elif r > 60.71 and r <= 69.64:#case 5:
		print("c5")
		case = 5
		rosberg.brazil = 0
		hamilton.brazil = 25
	    elif r > 69.64 and r <= 80.35:#case 6: 105
		print("c6")
		case = 6
		rosberg.brazil = 25
		hamilton.brazil = 15
	    elif r > 80.35 and r <= 82.14:#case 8: 17
		print("c8")
		case = 8
		rosberg.brazil = 25
		hamilton.brazil = 6
	    elif r > 82.14 and r <= 83.93:#case 9: 17
		print("c9")
		case = 9
		rosberg.brazil = 0
		hamilton.brazil = 0
	    elif r > 83.93 and r <= 85.72:#case 10: 17
		print("c10")
		case = 10
		rosberg.brazil = 6
		hamilton.brazil = 25
	    elif r > 85.72 and r <= 87.51:#case 11: 17
		print("c11")
		case = 11
		rosberg.brazil = 10
		hamilton.brazil = 25
	    elif r > 87.51 and r <= 89.3:#case 12: 17
		print("c12")
		case = 12
		rosberg.brazil = 25
		hamilton.brazil = 10
	    elif r > 89.3 and r <= 92.87:#case 13: 35
		print("c13")
		case = 13
		rosberg.brazil = 12
		hamilton.brazil = 25
	    elif r > 92.87 and r <= 96.44:#case 14: 35
		print("c14")
		case = 14
		rosberg.brazil = 15
		hamilton.brazil = 25
	    elif r > 96.44 and r <= 98.23:#case 15: 17
		print("c15")
		case = 15
		rosberg.brazil = 15
		hamilton.brazil = 18
	    elif r > 98.23 and r <= 100.02:#case 17: 17
		print("c17")
		case = 17
		rosberg.brazil = 12
		hamilton.brazil = 0
